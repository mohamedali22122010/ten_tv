...
return [
     ...
     */
    'custom_url_generator_class' => App\Helpers\CustomUrlGenerator::class,//App\Helpers\LocalUrlGenerator::class,//null
    ...
    's3' => [
         ...
         */
        'domain' => 'https://s3-eu-west-1.amazonaws.com/companyprofile-local/',
    ],
